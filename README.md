<!-- PROJECT NAME -->
<div align="center">
  <h1 align="center">Analytic Logging Microservice</h1>
</div>
<br>
<br>
<!-- TABLE OF CONTENTS -->
...
Build a internally mircoservices that is designed to take heavy loads of API calls to store analytics
...
```bash
git clone https://github.com/Ahmad-Chebbo/analytic-logging-microservice.git
```
